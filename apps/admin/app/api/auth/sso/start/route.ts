...
/**
 * Begin SSO sign-in for the admin console. Asks the identity service to start an
 * OIDC flow, stashes the signed `state` in a short-lived httpOnly cookie
 * (replayed on callback to defeat CSRF), and redirects to the school's IdP.
 */
