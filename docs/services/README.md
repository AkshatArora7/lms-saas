...
| [tenant](tenant.md) | 4002 | control-plane DB | `tenant`, `plan`, `subscription`, `tenant_setting`, `tenant_branding`, `tenant_admin_delegation`, `tenant_silo_migration` |
...
| attendance | calendar, enrollment, notification, reporting, user-org |
