...
SERVICES = [
    ...
    },
    {
        ...
        "deps": ["enrollment (roster)", "calendar (timetable)", "notification (absence alerts)", "reporting (exports)", "user-org (consented-guardian resolution for absence/tardy fan-out, via GET /students/:studentId/guardians/authorized)"],
