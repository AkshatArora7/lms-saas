/**
 * ai service.
 * LLM features (Lumi-equivalent): content/question generation, grading assistance, course Q&A. RAG over tenant content (pgvector + Groq); security-trimmed by tenant.
 *
